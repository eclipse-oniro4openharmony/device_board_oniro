...
cp_list=(
    $OHOS_SOURCE_ROOT/third_party/bounds_checking_function              ./bounds_checking_function
    $OHOS_SOURCE_ROOT/device/soc/hisilicon/common/platform/wifi         drivers/hdf/wifi
    $OHOS_SOURCE_ROOT/third_party/FreeBSD/sys/dev/evdev                 drivers/hdf/evdev
    $OHOS_SOURCE_ROOT/kernel/linux/common_modules/ucollection           drivers/staging/ucollection
)
...
function main()
{
    ...
    patch -N -p1 < $HDF_PATCH_FILE || true
    ln_hdf_repos
