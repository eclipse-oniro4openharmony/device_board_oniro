qemu-system-x86_64 -accel whpx -machine q35 -smp 6 -m 4096M -boot c -nographic -vga none -device virtio-gpu-pci,xres=360,yres=720,max_outputs=1,addr=08.0 -display sdl,gl=off -rtc base=utc,clock=host -device es1370 -initrd ramdisk.img -kernel bzImage ^
