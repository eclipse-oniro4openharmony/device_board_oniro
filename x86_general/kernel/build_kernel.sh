...
DEFCONFIG_FILE=x86_general_defconfig

pushd ${ROOT_DIR}/kernel/linux/${KERNEL_VERSION}
OUT_PKG_DIR=${ROOT_DIR}/out/x86_general/packages/phone/images
export PRODUCT_PATH=vendor/oniro/x86_general
export DEVICE_COMPANY=oniro
export DEVICE_NAME=x86_general
export PRODUCT_COMPANY=oniro

BUILD_SCRIPT_PATH=${ROOT_DIR}/device/board/oniro/x86_general
...
KERNEL_PATCH_PATH=${ROOT_DIR}/device/board/oniro/x86_general/kernel/patch/${KERNEL_VERSION}
HDF_PATCH=${KERNEL_PATCH_PATH}/common_patch/hdf.patch
KERNEL_CONFIG_FILE=${ROOT_DIR}/device/board/oniro/x86_general/kernel/x86_general_linux_defconfig
